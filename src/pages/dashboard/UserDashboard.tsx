...
import MembershipDetailsModal from "@/components/dashboard/MembershipDetailsModal";
import {
  AlertDialogHeader,
  AlertDialogFooter,
...
import AddGoalModal from "@/components/dashboard/fitness/AddGoalModal";
import AddAssessmentModal from "@/components/dashboard/fitness/AddAssessmentModal";
import AddRecordModal from "@/components/dashboard/fitness/AddRecordModal";
import ContactSupportModal from "@/components/dashboard/settings/ContactSupportModal";
...
import PaymentMethodModal from "@/components/dashboard/payment/PaymentMethodModal";
import UpdateMeasurementsModal from "@/components/dashboard/fitness/UpdateMeasurementsModal";
import WorkoutDetailsModal from "@/components/dashboard/fitness/WorkoutDetailsModal";
...
const UserDashboard = () => {
  ...
  const [isUpdateMeasurementsModalOpen, setIsUpdateMeasurementsModalOpen] =
    useState(false);
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <motion.aside
        className={`bg-neogym-dark text-white ${
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              >
                ...
                <p className="text-3xl font-bold">
                  {userData.stats.caloriesBurned.toLocaleString()}
                </p>
                    ...
                    <div className="flex justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Current: {userData.goals.weight.current}{" "}
                          {userData.goals.weight.unit} / Target:{" "}
                          {userData.goals.weight.target}{" "}
                          {userData.goals.weight.unit}
                        </p>
                      </div>
                      <span className="text-sm font-medium">
                        {userData.goals.weight.progress}%
                      </span>
                    </div>
                    <Progress
                      value={userData.goals.weight.progress}
                      className="h-2"
                    />
                  </div>
                    ...
                    <div className="flex justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          ...
                          Target: {userData.goals.workoutsPerWeek.target}{" "}
                          workouts
                        </p>
                      </div>
                      <span className="text-sm font-medium">
                        {userData.goals.workoutsPerWeek.progress}%
                      </span>
                    </div>
                    <Progress
                      value={userData.goals.workoutsPerWeek.progress}
                      className="h-2"
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Current: {userData.goals.cardio.current}{" "}
                          {userData.goals.cardio.unit} / Target:{" "}
                          {userData.goals.cardio.target}{" "}
                          {userData.goals.cardio.unit}
                        </p>
                      </div>
                      <span className="text-sm font-medium">
                        {userData.goals.cardio.progress}%
                      </span>
                    </div>
                    <Progress
                      value={userData.goals.cardio.progress}
                      className="h-2"
                    />
                  </div>
                </div>
              ...
              <div className="md:col-span-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Important information for your workouts
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form className="space-y-4">
                          ...
                          <div
                            ...
                            className={`border rounded-lg p-4 transition-all hover:shadow-md cursor-pointer ${
                              selectedClassId === cls.id
                                ? "border-neogym-red bg-red-50"
                                : ""
                            }`}
                            onClick={() =>
                              setSelectedClassId(
                                cls.id === selectedClassId ? null : cls.id
                              )
                            }
                          >
                            <div className="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    {userData.upcomingClasses.length === 0 ? (
                      ...
                      <div className="space-y-4">
                        {userData.upcomingClasses.map((cls) => (
                          <div
                            key={cls.id}
                            className="border rounded-lg p-3 hover:border-neogym-red"
                          >
                            <h4 className="font-medium">{cls.name}</h4>
                            <p className="text-sm text-gray-600">
                              Instructor: {cls.instructor}
                    ...
                    <div className="space-y-4">
                      <div className="rounded-lg bg-blue-50 border border-blue-200 p-4">
                        ...
                        <p className="text-sm text-blue-600">
                          Perfect for recovery after your recent strength
                          training.
                        </p>
                      ...
                      <div className="rounded-lg bg-purple-50 border border-purple-200 p-4">
                        ...
                        <p className="text-sm text-purple-600">
                          Boost your cardio and meet your calorie goals faster.
                        </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Track your physical changes
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        {Object.entries(
                          userData.fitnessProgress.measurements
                        ).map(([key, value]) => (
                          <div
                            key={key}
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="flex justify-between mb-1">
                            ...
                            <span className="text-sm text-gray-500">
                              {userData.goals.weight.current}/
                              {userData.goals.weight.target} kg
                            </span>
                          </div>
                          <Progress
                            value={userData.goals.weight.progress}
                        ...
                        <div>
                          <div className="flex justify-between mb-1">
                            ...
                            <span className="text-sm text-gray-500">
                              {userData.goals.workoutsPerWeek.current}/
                              {userData.goals.workoutsPerWeek.target}
                            </span>
                          </div>
                          <Progress
                            value={userData.goals.workoutsPerWeek.progress}
                        ...
                        <div>
                          <div className="flex justify-between mb-1">
                            ...
                            <span className="text-sm text-gray-500">
                              {userData.goals.cardio.current}/
                              {userData.goals.cardio.target} hours
                            </span>
                          </div>
                          <Progress
                            value={userData.goals.cardio.progress}
                        ...
                        <Button
                          ...
                          className="w-full mt-2 bg-neogym-red hover:bg-neogym-red/90"
                        >
                          Set New Goals
                        </Button>
                      </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="rounded-md ">
                      <div className="grid grid-cols-5 font-medium text-sm py-3 px-2 border-b bg-gray-50">
                        <div>Date</div>
                        <div>Workout</div>
                        <div>Duration</div>
                        <div>Calories</div>
                      ...
                      {workoutHistoryData.map((workout) => (
                        <div
                          key={workout.id}
                          className="grid grid-cols-5 p-3 text-sm border-b last:border-b-0"
                        >
              ...
              <div>
                <Card className="mb-6">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {userData.fitnessProgress.personalRecords.map(
                        (record, index) => (
                          <div
                            key={index}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {userData.fitnessProgress.fitnessAssessments.map(
                        (assessment, index) => (
                    ...
                    <Button
                      ...
                      className="w-full mt-4 bg-neogym-red hover:bg-neogym-red/90"
                    >
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between mb-3">
                        ...
                        <p className="font-bold">
                          ${userData.paymentInfo.nextPayment.amount.toFixed(2)}
                        </p>
                      </div>
                      ...
                      <div className="mt-4 pt-4 border-t">
                        <p className="text-sm text-gray-500 mb-2">
                          Your {userData.membership} membership will be
                        ...
                        <div className="flex justify-between">
                          <Button
                            onClick={() => setIsMembershipModalOpen(true)}
                            variant="link"
                            className="text-neogym-red text-sm p-0"
                          >
                            View membership details
                          </Button>
                          ...
                          <div className="flex justify-end mt-3 space-x-2">
                            {!card.isDefault && (
                              <Button
                                ...
                                size="sm"
                                onClick={() => {
                                  const updatedMethods = paymentMethods.map(
                                    (method) => ({
                                      ...method,
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 mb-4">
                      Deactivating your account will suspend your membership and
                      hide your profile. You can reactivate at any time by
                      logging back in.
                    </p>
                    <Button
                      variant="destructive"
      ...
      />{" "}
      <AddGoalModal open={isGoalModalOpen} onOpenChange={setIsGoalModalOpen} />
      <AddAssessmentModal
      ...
      <ContactSupportModal
        ...
        onOpenChange={setIsContactSupportModalOpen}
      />
      <HelpCenterModal
        open={isHelpCenterModalOpen}
        onOpenChange={setIsHelpCenterModalOpen}
      />
