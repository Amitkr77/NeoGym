...
import AddClassModal from "@/components/dashboard/classes/AddClassModal";
...
const adminData = {
  ...
  equipment: [
    {
      ...
      type: "cardio",
      description: "A machine used for walking or running while staying in the same place.",
      purchaseDate: new Date("2023-01-10"),
      cost: 1500.99,
      manufacturer: "Life Fitness",
      serialNumber: "LF123456",
      status: "operational",
    ...
    },
    {
      ...
      type: "strength",
      description: "A piece of equipment used for upper body strength training, specifically targeting the chest, shoulders, and triceps.",
      purchaseDate: new Date("2022-07-05"),
      cost: 800.75,
      manufacturer: "Rogue Fitness",
      serialNumber: "RF987654",
      status: "operational",
      lastMaintenance:"mar 15"
    },
    {
      ...
      location: "Cardio Area",
      type: "cardio",
      description: "An exercise machine that simulates stair climbing, walking, or running.",
      purchaseDate: new Date("2021-03-12"),
      cost: 1200.00,
      manufacturer: "Precor",
      serialNumber: "PC111222",
    ...
    },
    {
      ...
      location: "Weight Room",
      type: "strength",
      description: "A piece of equipment used for performing squats with a barbell.",
      purchaseDate: new Date("2022-08-03"),
      cost: 950.25,
      manufacturer: "Nautilus",
      serialNumber: "NT333444",
      status: "operational",
      lastMaintenance:"mar 15"
    },
    {
      ...
      location: "Cardio Area",
      type: "cardio",
      description: "A machine designed to simulate rowing and provides a full-body workout.",
      purchaseDate: new Date("2021-10-15"),
      cost: 1100.40,
      manufacturer: "Concept2",
      serialNumber: "C2555666",
      status: "operational",
      lastMaintenance:"mar 15"
    },
  ],
  ...
  tasks: [
    ...
    {
      id: 2,
      text: "Schedule maintenance for cardio machines",
      completed: false,
    },
...
const AdminDashboard = () => {
  ...
  const handleSave = (id: string, data: any) => {
    console.log("Equipment saved with ID:", id);
    console.log("Updated Data:", data);

    // Optionally, update the equipment state or send the data to an API
    setEquipment({ id, ...data });
  ...
  return (
    <div className="flex h-screen bg-gray-100">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-3xl font-bold">
                        {adminData.stats.totalMembers}
                      </p>
                      <p className="text-gray-600 text-sm">
                        <span className="text-green-500">
                          +{adminData.stats.newMembersThisMonth}
                        </span>{" "}
                        this month
                      </p>
                    </div>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-3xl font-bold">
                        ${adminData.stats.revenue.thisMonth.toLocaleString()}
                      </p>
                      <p className="text-gray-600 text-sm">
                        <span
                          className={
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-3xl font-bold">
                        {adminData.stats.equipment.total}
                      </p>
                      <p className="text-gray-600 text-sm">
                        <span className="text-red-500">
                          {adminData.stats.equipment.needMaintenance}
                        </span>{" "}
                        need maintenance
                      </p>
                    </div>
                  ...
                  <div className="space-y-4">
                    {adminData.membershipsByType.map((item, index) => (
                      <div key={index}>
                        ...
                        <Progress
                          value={Math.round(
                            (item.count / adminData.stats.totalMembers) * 100
                          )}
                          className="h-2"
                        />
                      </div>
          ...
          >
              ...
              <div className="flex justify-between items-center mt-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="bg-neogym-red text-white"
                  >
                    1
                  </Button>
            ...
            <Dialog open={isAddMemberOpen} onOpenChange={setIsAddMemberOpen}>
              <DialogContent className="sm:max-w-[500px]">
                ...
                <Form {...form}>
                  <form
                    onSubmit={form.handleSubmit(handleMemberSubmit)}
                    className="space-y-4"
                  >
                    <FormField
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    <span className="text-green-500">+12.3%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
                      ...
                      >
                        <div
                          className={`w-full rounded-t-md ${
                            item.amount > 0 ? "bg-green-500" : "bg-gray-200"
                          }`}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        Personal Training - Michael Johnson
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">Revenue</td>
                      <td className="px-6 py-4 whitespace-nowrap text-green-600">
                        +$75.00
                      ...
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-2">
                            ...
                            >
                              <span className="border border-yellow-600 rounded px-2 py-1 text-xs">
                                Maintenance
                              </span>
                            </button>
                          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    <span className="text-green-500">+2.1%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    <span className="text-red-500">-3</span> compared to last
                    month
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    <span className="text-green-500">+5.3%</span> from last
                    month
                  </p>
                </CardContent>
              </Card>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button className="bg-gray-50 hover:bg-gray-100 p-4 rounded-md border flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Renewal rates and upcoming renewals
                        </p>
                      </div>
                      <FileText className="text-gray-400" />
                    </button>
                    ...
                    <button className="bg-gray-50 hover:bg-gray-100 p-4 rounded-md border flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Visit frequency and class participation
                        </p>
                      </div>
                      <FileText className="text-gray-400" />
                    </button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button className="bg-gray-50 hover:bg-gray-100 p-4 rounded-md border flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Attendance rates for all classes
                        </p>
                      </div>
                      <FileText className="text-gray-400" />
                    </button>
      ...
      {/* <EditEquipmentModal
        open={isEditEquipment}
        onOpenChange={setIsEditEquipment}
        onSave={handleSave}
        equipment={equipment}
      /> */}
    </div>
